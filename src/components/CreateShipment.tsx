...
const WEBHOOK_URL = import.meta.env.VITE_WEBHOOK_URL || "https://moojjvple.app.n8n.cloud/webhook-test/jblogistics";
const WEBHOOK_GET_URL = import.meta.env.VITE_WEBHOOK_GET_URL || "https://moojjvple.app.n8n.cloud/webhook-test/jblogistics";
