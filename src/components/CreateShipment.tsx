...
const CreateShipment = () => {
  ...
  const validateForm = (): boolean => {
    ...
    if (!formData.pickupLandmark.trim())
      newErrors.pickupLandmark = "Pickup landmark is required";
  ...
  const handlePhoneChange = (
    ...
    field: "senderPhone" | "receiverPhone",
  ) => {
        ...
        <div className="container-responsive py-8 md:py-16 lg:py-24">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-sm md:text-base text-gray-600 mb-6 md:mb-8">
              Your package has been registered. Use the tracking number below to
        ...
        <form onSubmit={handleSubmit} className="max-w-4xl mx-auto">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6 md:p-8 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  Pickup Landmark/Specific Address{" "}
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6 md:p-8 mb-6">
            ...
            <div className="grid grid-cols-1 gap-6">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700 mb-2">
                  Delivery Landmark/Specific Address{" "}
                  <span className="text-red-500">*</span>
                </label>
                <input
                  type="text"
            ...
            <div className="space-y-6">
              <div>
                ...
                >
                  ...
                  <option value="Local Bike Delivery (1-8 hours) - ₦3,000">
                    Local Bike Delivery - Within Port Harcourt (1-8 hours) -
                    ₦3,000
                  </option>
                  <option value="Express Delivery (1-2 hours) - ₦5,000">
                    Express Delivery - Ultra-Fast Service (1-2 hours) - ₦5,000
                  </option>
                </select>
                {errors.serviceType && (
                  <p className="text-red-500 text-sm mt-1">
